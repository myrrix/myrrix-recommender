...
pageContext.setAttribute("numPartitions", numPartitions);
  ...
  if (rec.getBucket() != null || rec.getInstanceID() != null) {
    ...
    for (Map.Entry<String,ServletStats> entry : timings.entrySet()) {
      ...
      out.write("<hr/>");
      out.write("<h2>");
      out.write("<span onclick=\"expandOrCollapse('feature-space','feature-space-arrow');document.getElementById('feature-space-map').src='/som.jspx?matrix=item'\">");
      ...
      out.write("</em>");
      out.write("<br/>");
      out.write("<a onclick=\"document.getElementById('feature-space-map').src='/som.jspx?matrix=user'\" href=\"#\">");
      out.write("Compute New User-Feature Map");
      out.write("</a>");
      out.write(" &middot;\n    ");
      out.write("<a onclick=\"document.getElementById('feature-space-map').src='/som.jspx?matrix=item'\" href=\"#\">");
      out.write("Compute New Item-Feature Map");
      out.write("</a>");
      out.write("</p>");
      out.write("<iframe style=\"width:100%;height:660px;border:0;padding:0;margin:0\" src=\"\" id=\"feature-space-map\">");
