 ...
 * Generated at: 2012-10-30 10:13:16 UTC
...
pageContext.setAttribute("numPartitions",
                         ((ReloadingReference<List<?>>) application.getAttribute(AbstractMyrrixServlet.ALL_PARTITIONS_REF_KEY)).get().size());
      ...
      out.write("</td>");
      out.write("<td style=\"text-align:left\">");
      out.write("<a href=\"" + (java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("file://${localInputDir}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false) + "\">");
      out.write("<code>");
